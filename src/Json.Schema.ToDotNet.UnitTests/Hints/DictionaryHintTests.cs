    ...
    public class DictionaryHintTests : CodeGenerationTestBase
    {
        public class TestCase
        {
            public TestCase(
                ...
                string expectedEqualityComparerText,
                bool definesAdditionalClass)
            {
                ...
                ExpectedEqualityComparerText = expectedEqualityComparerText;
            ...
            public string ExpectedEqualityComparerText;
            ...
            public void Deserialize(IXunitSerializationInfo info)
            {
                ...
                ExpectedEqualityComparerText = info.GetValue<string>(nameof(ExpectedEqualityComparerText));
            ...
            public void Serialize(IXunitSerializationInfo info)
            {
                ...
                info.AddValue(nameof(ExpectedEqualityComparerText), ExpectedEqualityComparerText);
...
namespace N
{
    ...
    internal sealed class CComparer : IComparer<C>
    {
        ...
        public int Compare(C left, C right)
        {
            ...
            compareResult = left.DictProp.DictionaryCompares(right.DictProp);
            if (compareResult != 0)
            {
                return compareResult;
            }
...
namespace N
{
    ...
    internal sealed class CComparer : IComparer<C>
    {
        ...
        public int Compare(C left, C right)
        {
            ...
            compareResult = left.DictProp.DictionaryCompares(right.DictProp, DComparer.Instance);
            if (compareResult != 0)
            {
                return compareResult;
            }
...
namespace N
{
    ...
    internal sealed class CComparer : IComparer<C>
    {
        ...
        public int Compare(C left, C right)
        {
            ...
            compareResult = left.DictProp.DictionaryCompares(right.DictProp, BComparer.Instance);
            if (compareResult != 0)
            {
                return compareResult;
            }
        ...
        public void DictionaryHint(TestCase testCase)
        {
            ...
            var expectedContentsDictionary = new Dictionary<string, ExpectedContents>
            {
                [Settings.RootClassName] = new ExpectedContents
                {
                    ...
                    EqualityComparerClassContents = testCase.ExpectedEqualityComparerText,
        ...
        public IDictionary<Uri, string> Properties { get; set; }
            ...
            var expectedContentsDictionary = new Dictionary<string, ExpectedContents>
            {
                ...
                ["Def1"] = new ExpectedContents
                {
                    ...
                    EqualityComparerClassContents = null
                },
