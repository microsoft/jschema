...
## **Unreleased**
* FEATURE: Add new option for specifying .NET type to express Json numbers: `--generate-json-number-as = double | float | decimal | auto` with a default of `double`. [#165](https://github.com/microsoft/jschema/pull/165)
